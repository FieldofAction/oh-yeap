...
export const PATTERNS = [
  ...
  { id:"pl-001", num:1, title:"Independent Regions", scale:"towns", group:"network-of-lattices", appliedIn:[], notes:"" },
  ...
  // ── Towns: City Policies ──
  { id:"pl-008", num:8, title:"Mosaic of Subcultures", scale:"towns", group:"city-policies", appliedIn:[], notes:"" },
  { id:"pl-009", num:9, title:"Scattered Work", scale:"towns", group:"city-policies", appliedIn:[], notes:"" },
  { id:"pl-010", num:10, title:"Magic of the City", scale:"towns", group:"city-policies", appliedIn:[], notes:"" },
  ...
  { id:"pl-013", num:13, title:"Subculture Boundary", scale:"towns", group:"communities", appliedIn:[], notes:"" },
  { id:"pl-014", num:14, title:"Identifiable Neighborhood", scale:"towns", group:"communities", appliedIn:[], notes:"" },
  ...
  { id:"pl-018", num:18, title:"Network of Learning", scale:"towns", group:"community-networking", appliedIn:[], notes:"" },
  ...
  { id:"pl-024", num:24, title:"Sacred Sites", scale:"towns", group:"community-policies", appliedIn:[], notes:"" },
  { id:"pl-025", num:25, title:"Access to Water", scale:"towns", group:"community-policies", appliedIn:[], notes:"" },
  { id:"pl-026", num:26, title:"Life Cycle", scale:"towns", group:"community-policies", appliedIn:[], notes:"" },
  { id:"pl-027", num:27, title:"Men and Women", scale:"towns", group:"community-policies", appliedIn:[], notes:"" },

  // ── Towns: Local Centers ──
  { id:"pl-028", num:28, title:"Eccentric Nucleus", scale:"towns", group:"local-centers", appliedIn:[], notes:"" },
  { id:"pl-029", num:29, title:"Density Rings", scale:"towns", group:"local-centers", appliedIn:[], notes:"" },
  { id:"pl-030", num:30, title:"Activity Nodes", scale:"towns", group:"local-centers", appliedIn:[], notes:"" },
  { id:"pl-031", num:31, title:"Promenade", scale:"towns", group:"local-centers", appliedIn:[], notes:"" },
  ...
  { id:"pl-036", num:36, title:"Degrees of Publicness", scale:"towns", group:"housing-clusters", appliedIn:[], notes:"" },
  { id:"pl-037", num:37, title:"House Cluster", scale:"towns", group:"housing-clusters", appliedIn:[], notes:"" },
  ...
  { id:"pl-041", num:41, title:"Work Community", scale:"towns", group:"work-communities", appliedIn:[], notes:"" },
  { id:"pl-042", num:42, title:"Industrial Ribbon", scale:"towns", group:"work-communities", appliedIn:[], notes:"" },
  { id:"pl-043", num:43, title:"University as a Marketplace", scale:"towns", group:"work-communities", appliedIn:[], notes:"" },
  { id:"pl-044", num:44, title:"Local Town Hall", scale:"towns", group:"work-communities", appliedIn:[], notes:"" },
  { id:"pl-045", num:45, title:"Necklace of Community Projects", scale:"towns", group:"work-communities", appliedIn:[], notes:"" },
  ...
  { id:"pl-050", num:50, title:"T Junctions", scale:"towns", group:"local-networking", appliedIn:[], notes:"" },
  { id:"pl-051", num:51, title:"Green Streets", scale:"towns", group:"local-networking", appliedIn:[], notes:"" },
  { id:"pl-052", num:52, title:"Network of Paths and Cars", scale:"towns", group:"local-networking", appliedIn:[], notes:"" },
  { id:"pl-053", num:53, title:"Main Gateways", scale:"towns", group:"local-networking", appliedIn:[], notes:"" },
  { id:"pl-054", num:54, title:"Road Crossing", scale:"towns", group:"local-networking", appliedIn:[], notes:"" },
  { id:"pl-055", num:55, title:"Raised Walk", scale:"towns", group:"local-networking", appliedIn:[], notes:"" },
  ...
  { id:"pl-058", num:58, title:"Carnival", scale:"towns", group:"community-recreation", appliedIn:[], notes:"" },
  { id:"pl-059", num:59, title:"Quiet Backs", scale:"towns", group:"community-recreation", appliedIn:[], notes:"" },
  { id:"pl-060", num:60, title:"Accessible Green", scale:"towns", group:"community-recreation", appliedIn:[], notes:"" },
  { id:"pl-061", num:61, title:"Small Public Squares", scale:"towns", group:"community-recreation", appliedIn:[], notes:"" },
  { id:"pl-062", num:62, title:"High Places", scale:"towns", group:"community-recreation", appliedIn:[], notes:"" },
  { id:"pl-063", num:63, title:"Dancing in the Street", scale:"towns", group:"community-recreation", appliedIn:[], notes:"" },
  ...
  { id:"pl-066", num:66, title:"Holy Ground", scale:"towns", group:"community-recreation", appliedIn:[], notes:"" },

  // ── Towns: Local Recreation ──
  { id:"pl-067", num:67, title:"Common Land", scale:"towns", group:"local-recreation", appliedIn:[], notes:"" },
  { id:"pl-068", num:68, title:"Connected Play", scale:"towns", group:"local-recreation", appliedIn:[], notes:"" },
  { id:"pl-069", num:69, title:"Public Outdoor Room", scale:"towns", group:"local-recreation", appliedIn:[], notes:"" },
  { id:"pl-070", num:70, title:"Grave Sites", scale:"towns", group:"local-recreation", appliedIn:[], notes:"" },
  ...
  { id:"pl-073", num:73, title:"Adventure Playground", scale:"towns", group:"local-recreation", appliedIn:[], notes:"" },
  { id:"pl-074", num:74, title:"Animals", scale:"towns", group:"local-recreation", appliedIn:[], notes:"" },

  // ── Towns: Families ──
  { id:"pl-075", num:75, title:"The Family", scale:"towns", group:"families", appliedIn:[], notes:"" },
  ...
  { id:"pl-079", num:79, title:"Your Own Home", scale:"towns", group:"families", appliedIn:[], notes:"" },

  // ── Towns: Workgroups ──
  { id:"pl-080", num:80, title:"Self-Governing Workshops and Offices", scale:"towns", group:"workgroups", appliedIn:[], notes:"" },
  ...
  { id:"pl-083", num:83, title:"Master and Apprentices", scale:"towns", group:"workgroups", appliedIn:[], notes:"" },
  ...
  { id:"pl-087", num:87, title:"Individually Owned Shops", scale:"towns", group:"local-gathering", appliedIn:[], notes:"" },
  ...
  { id:"pl-095", num:95, title:"Building Complex", scale:"buildings", group:"group-of-buildings", appliedIn:[], notes:"" },
  ...
  { id:"pl-098", num:98, title:"Circulation Realms", scale:"buildings", group:"group-of-buildings", appliedIn:[], notes:"" },
  { id:"pl-099", num:99, title:"Main Building", scale:"buildings", group:"group-of-buildings", appliedIn:[], notes:"" },
  { id:"pl-100", num:100, title:"Pedestrian Street", scale:"buildings", group:"group-of-buildings", appliedIn:[], notes:"" },
  { id:"pl-101", num:101, title:"Building Thoroughfare", scale:"buildings", group:"group-of-buildings", appliedIn:[], notes:"" },
  { id:"pl-102", num:102, title:"Family of Entrances", scale:"buildings", group:"group-of-buildings", appliedIn:[], notes:"" },
  ...
  { id:"pl-104", num:104, title:"Site Repair", scale:"buildings", group:"siting", appliedIn:[], notes:"" },
  { id:"pl-105", num:105, title:"South Facing Outdoors", scale:"buildings", group:"siting", appliedIn:[], notes:"" },
  { id:"pl-106", num:106, title:"Positive Outdoor Space", scale:"buildings", group:"siting", appliedIn:[], notes:"" },
  { id:"pl-107", num:107, title:"Wings of Light", scale:"buildings", group:"siting", appliedIn:[], notes:"" },
  { id:"pl-108", num:108, title:"Connected Buildings", scale:"buildings", group:"siting", appliedIn:[], notes:"" },
  { id:"pl-109", num:109, title:"Long Thin House", scale:"buildings", group:"siting", appliedIn:[], notes:"" },

  // ── Buildings: Building Layout ──
  { id:"pl-110", num:110, title:"Main Entrance", scale:"buildings", group:"building-layout", appliedIn:[], notes:"" },
  { id:"pl-111", num:111, title:"Half-Hidden Garden", scale:"buildings", group:"building-layout", appliedIn:[], notes:"" },
  { id:"pl-112", num:112, title:"Entrance Transition", scale:"buildings", group:"building-layout", appliedIn:[], notes:"" },
  { id:"pl-113", num:113, title:"Car Connection", scale:"buildings", group:"building-layout", appliedIn:[], notes:"" },
  { id:"pl-114", num:114, title:"Hierarchy of Open Space", scale:"buildings", group:"building-layout", appliedIn:[], notes:"" },
  { id:"pl-115", num:115, title:"Courtyards Which Live", scale:"buildings", group:"building-layout", appliedIn:[], notes:"" },
  { id:"pl-116", num:116, title:"Cascade of Roofs", scale:"buildings", group:"building-layout", appliedIn:[], notes:"" },
  ...
  { id:"pl-120", num:120, title:"Paths and Goals", scale:"buildings", group:"between-buildings", appliedIn:[], notes:"" },
  { id:"pl-121", num:121, title:"Path Shape", scale:"buildings", group:"between-buildings", appliedIn:[], notes:"" },
  { id:"pl-122", num:122, title:"Building Fronts", scale:"buildings", group:"between-buildings", appliedIn:[], notes:"" },
  { id:"pl-123", num:123, title:"Pedestrian Density", scale:"buildings", group:"between-buildings", appliedIn:[], notes:"" },
  { id:"pl-124", num:124, title:"Activity Pockets", scale:"buildings", group:"between-buildings", appliedIn:[], notes:"" },
  ...
  { id:"pl-127", num:127, title:"Intimacy Gradient", scale:"buildings", group:"light-and-space", appliedIn:[], notes:"" },
  { id:"pl-128", num:128, title:"Indoor Sunlight", scale:"buildings", group:"light-and-space", appliedIn:[], notes:"" },
  { id:"pl-129", num:129, title:"Common Areas at the Heart", scale:"buildings", group:"light-and-space", appliedIn:[], notes:"" },
  { id:"pl-130", num:130, title:"Entrance Room", scale:"buildings", group:"light-and-space", appliedIn:[], notes:"" },
  { id:"pl-131", num:131, title:"The Flow Through Rooms", scale:"buildings", group:"light-and-space", appliedIn:[], notes:"" },
  ...
  { id:"pl-134", num:134, title:"Zen View", scale:"buildings", group:"light-and-space", appliedIn:[], notes:"" },
  { id:"pl-135", num:135, title:"Tapestry of Light and Dark", scale:"buildings", group:"light-and-space", appliedIn:[], notes:"" },
  ...
  { id:"pl-141", num:141, title:"A Room of One's Own", scale:"buildings", group:"private-rooms", appliedIn:[], notes:"" },
  ...
  { id:"pl-148", num:148, title:"Small Work Groups", scale:"buildings", group:"public-rooms", appliedIn:[], notes:"" },
  ...
  { id:"pl-159", num:159, title:"Light on Two Sides of Every Room", scale:"buildings", group:"liminal-space", appliedIn:[], notes:"" },
  ...
  { id:"pl-163", num:163, title:"Outdoor Room", scale:"buildings", group:"liminal-space", appliedIn:[], notes:"" },
  { id:"pl-164", num:164, title:"Street Windows", scale:"buildings", group:"liminal-space", appliedIn:[], notes:"" },
  { id:"pl-165", num:165, title:"Opening to the Street", scale:"buildings", group:"liminal-space", appliedIn:[], notes:"" },
  ...
  { id:"pl-168", num:168, title:"Connection to the Earth", scale:"buildings", group:"liminal-space", appliedIn:[], notes:"" },
  ...
  { id:"pl-172", num:172, title:"Garden Growing Wild", scale:"buildings", group:"gardens", appliedIn:[], notes:"" },
  ...
  { id:"pl-178", num:178, title:"Compost", scale:"buildings", group:"gardens", appliedIn:[], notes:"" },

  // ── Buildings: Minor Rooms ──
  { id:"pl-179", num:179, title:"Alcoves", scale:"buildings", group:"minor-rooms", appliedIn:[], notes:"" },
  { id:"pl-180", num:180, title:"Window Place", scale:"buildings", group:"minor-rooms", appliedIn:[], notes:"" },
  ...
  { id:"pl-190", num:190, title:"Ceiling Height Variety", scale:"buildings", group:"shaping-rooms", appliedIn:[], notes:"" },
  ...
  { id:"pl-193", num:193, title:"Half-Open Wall", scale:"buildings", group:"shaping-rooms", appliedIn:[], notes:"" },
  ...
  { id:"pl-197", num:197, title:"Thick Walls", scale:"buildings", group:"thick-walls", appliedIn:[], notes:"" },
  ...
  { id:"pl-204", num:204, title:"Secret Place", scale:"buildings", group:"thick-walls", appliedIn:[], notes:"" },

  // ── Construction: Emergent Structure ──
  { id:"pl-205", num:205, title:"Structure Follows Social Spaces", scale:"construction", group:"emergent-structure", appliedIn:[], notes:"" },
  { id:"pl-206", num:206, title:"Efficient Structure", scale:"construction", group:"emergent-structure", appliedIn:[], notes:"" },
  { id:"pl-207", num:207, title:"Good Materials", scale:"construction", group:"emergent-structure", appliedIn:[], notes:"" },
  { id:"pl-208", num:208, title:"Gradual Stiffening", scale:"construction", group:"emergent-structure", appliedIn:[], notes:"" },
  ...
  { id:"pl-210", num:210, title:"Floor and Ceiling Layout", scale:"construction", group:"structural-layout", appliedIn:[], notes:"" },
  ...
  { id:"pl-214", num:214, title:"Root Foundations", scale:"construction", group:"erecting-frame", appliedIn:[], notes:"" },
  ...
  { id:"pl-238", num:238, title:"Filtered Light", scale:"construction", group:"interior-details", appliedIn:[], notes:"" },
  ...
  { id:"pl-249", num:249, title:"Ornament", scale:"construction", group:"ornamentation", appliedIn:[], notes:"" },
  { id:"pl-250", num:250, title:"Warm Colors", scale:"construction", group:"ornamentation", appliedIn:[], notes:"" },
  { id:"pl-251", num:251, title:"Different Chairs", scale:"construction", group:"ornamentation", appliedIn:[], notes:"" },
  { id:"pl-252", num:252, title:"Pools of Light", scale:"construction", group:"ornamentation", appliedIn:[], notes:"" },
  { id:"pl-253", num:253, title:"Things From Your Life", scale:"construction", group:"ornamentation", appliedIn:[], notes:"" },
];
